...
leap = media.Movie("Leap!",
                   ...
                   "http://nextoons.ir/wp-content/uploads/2017/08/Leap-2016-Poster-6.jpg",
...
spork = media.Movie("Spork",
                    ...
                    "https://images-na.ssl-images-amazon.com/images/I/81c0Pzi2E7L._SL1500_.jpg",
                    "https://www.youtube.com/watch?v=VDma1UM1FCk")                 
annie = media.Movie("Annie",
                    "Little Annie lives a hard knock life with her calculating "
                    "mother when suddenly everything changes",
                    "https://s3-ap-southeast-2.amazonaws.com/fna-wordpress-website06/wp-content/uploads/2016/10/25022919/Annie-2014-960x14401.jpg",
...
lala_land = media.Movie("La la land",
                        ...
                        "what they love. Suddenly success hits and their dreams "
...
wonder_woman = media.Movie("Wonder Woman",
                           ...
                           "http://cdn.collider.com/wp-content/uploads/2017/03/justice-league-wonder-woman-poster.jpg",
                           "https://www.youtube.com/watch?v=1Q8fG0TtVAY")
hidden_figures = media.Movie("Hidden Figures",
                             "Three very brilliant African-american women serve "
                             "as the brains behind one of the greatest "
...
descendants = media.Movie("Descendants 2",
                          ...
                          "https://a.dilcdn.com/bl/wp-content/uploads/sites/25/2017/01/D2-Heroes-Key-Art.jpg",
                          "https://www.youtube.com/watch?v=g0FLzL7c49c")

'''array of the listed movies above'''
movies = [leap, spork, annie, lala_land, beauty_and_the_beast, lego_batman, wonder_woman, hidden_figures, spider_man, descendants]
